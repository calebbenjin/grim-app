      ...
      <div className='heroFlex'>
        <div className='content'>
          ...
          <p>
            ...
            your family and friends need to bank accounts in Ukraine and nearby
            countries for $0* fees from the United States, Canada and Europe.
          </p>
        </div>
        <div className='trackForm'>
          <div className="trackFormContainer">
            <div className='formHeader'>
              <button onClick={handleToggle} className={trackFormBtn ? 'leftBtn' : 'leftBtn btnActive'}>RATES & FEES</button>
              <button onClick={() => setTrackFormBtn(true)} className={trackFormBtn ? 'rightBtn btnActive' : 'rightBtn'}>TRACK & RECEIVE</button>
            </div>
            {trackFormBtn ? (
              <div className='formBody track'>
              <form>
                <p>Enter the required information below to see if your money is available.</p>
