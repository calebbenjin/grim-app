          ...
          <div className='col-lg-6 mx-auto'>
            <div className='balanceCard'>
              <form onSubmit={handleSubmit(onSubmit)}>
                <h5 className='formTitle'>Enter your payment voulcher</h5>
                {isError ? <p className="errAlert">Incorrect Voulcher Number!</p> : null}
                {isSuccess ? (
                  <p className="successAlert">Awesome your Voulcher Number is correct!! Redirecting...</p>
                ) : null}
                <div className='formControl'>
                  <label htmlFor='name'>VOULCHER NUMBER</label>
                  <input
                    type='text'
                    {...register('voulcherNum', { required: true })}
                  />
                  {errors.voulcherNum && (
                    <small>Voulcher Number is required</small>
                  )}
                </div>
